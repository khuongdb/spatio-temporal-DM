...
from ddpm_module import ContextUnet
...
def train():
    ...
    dataset = StarmenDataset(data_dir="data", split="trn")
    train_loader = DataLoader(dataset, batch_size=batch_size, shuffle=True, num_workers=5)

    valid_loader = DataLoader(StarmenDataset(data_dir="data", split="val"), batch_size=batch_size, shuffle=False, num_workers=1)
